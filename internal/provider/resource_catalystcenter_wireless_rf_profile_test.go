...
func TestAccCcWirelessRFProfile(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("catalystcenter_wireless_rf_profile.test", "radio_type_a_fra_properties_client_select", "98"))
	checks = append(checks, resource.TestCheckResourceAttr("catalystcenter_wireless_rf_profile.test", "radio_type_a_fra_properties_client_reset", "2"))
...
func testAccCcWirelessRFProfileConfig_all() string {
	...
	config += `	radio_type_a_fra_properties_client_select = 98` + "\n"
	config += `	radio_type_a_fra_properties_client_reset = 2` + "\n"
